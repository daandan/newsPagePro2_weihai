...
(function (B, n) {
    ...
    function R(a, b, c, d, e) {
        var c = c || "", d = k(d, !1), e = k(e, "\t"),
            ...
            a = a.replace(/(<(?:p|p\s[^>]*)>)\s*(<\/p>)/ig, "$1<br />$2"), a = a.replace(/\u200B/g, ""),
            g = {};
        b && (l(b, function (a, b) {
    ...
    function Qa(a) {
        var b = a.moveEl, c = a.moveFn, d = a.clickEl || b, e = a.beforeDrag, i = [document], g = [{x: 0, y: 0}],
            h = [];
        ...
        d.mousedown(function (a) {
            var m = d.get(), o = t(b.css("left")), k = t(b.css("top")), n = b.width(), r = b.height(), q = a.pageX,
                p = a.pageY, s = !0;
            e && e();
            l(i, function (a, b) {
                function e(b) {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    if (d.length >
                        0) {
                        b.preventDefault();
                        var i = f(a.edit.iframe).pos(), g = Ua({
                            x: i.x + b.clientX,
                            y: i.y + b.clientY,
                            width: c,
    ...
    if (!B.KindEditor) {
        ...
        var z = navigator.userAgent.toLowerCase(),
            ...
            la = z.indexOf("gecko") > -1 && z.indexOf("khtml") == -1, ca = z.indexOf("applewebkit") > -1,
            Ja = z.indexOf("opera") > -1, Zb = z.indexOf("mobile") > -1, $b = /ipad|iphone|ipod/.test(z),
            T = document.compatMode != "CSS1Compat",
            F = (z = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(z)) ? z[1] : "0", Ba = (new Date).getTime(),
            P = Math.round, f = {
                DEBUG: !1,
            ...
            ac = u("img,table,input,textarea,button"), Fa = u("pre,style,script"),
        ...
        f.options = {
            ...
            items: ["source", "|", "undo", "redo", "|", "preview", "print", "template", "cut", "copy", "paste", "plainpaste", "wordpaste", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "subscript", "superscript", "clearhtml", "quickformat", "selectall", "|", "fullscreen", "/", "formatblock", "fontname", "fontsize", "|", "forecolor", "hilitecolor",
                "bold", "italic", "underline", "strikethrough", "lineheight", "removeformat", "|", "image", "flash", "media", "insertfile", "table", "hr", "emoticons", "map", "code", "pagebreak", "anchor", "link", "unlink", "|", "about"],
        ...
        var bb = !1, Kb = u("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"), z = u("33..40"),
            Ya = {};
        l(Kb, function (a, b) {
            Ya[a] = b
        });
        ...
        E(N, {
            init: function (a) {
                ...
                var b = this.startContainer, c = this.startOffset, d = this.endContainer, e = this.endOffset, f, g, h,
                    j = 1;
        ...
        E(ua, {
            init: function (a) {
                ...
                var a =
                        k(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer,
                    e = c.startOffset, i = X(d), g = this.win, h, j = !1;
            ...
            commonNode: function (a) {
                ...
                var c = this.range, d = c.endContainer, c = c.endOffset,
                    e = d.nodeType == 3 || c === 0 ? d : d.childNodes[c - 1], i = b(e);
                if (i) return i;
                ...
                var c = this.range, d =
                        c.startContainer, e = c.startOffset, i = c.endContainer, c = c.endOffset,
                    i = i.nodeType == 3 || c === 0 ? i : i.childNodes[c - 1],
                    d = b(d.nodeType == 3 || e === 0 ? d : d.childNodes[e - 1]), e = b(i);
        ...
        E(Q, {
            init: function (a) {
                ...
                if (this._alignEl) {
                    var i = f(this._alignEl), g = i.pos(), c = P(i[0].clientWidth / 2 - c / 2),
        ...
        E(va, Q, {
            init: function (a) {
                ...
                var d = k(a.themesPath, ""), e = a.bodyClass, i = a.cssPath, g = a.cssData,
        ...
        E(xa, Q, {
            init: function (a) {
                ...
                var b = a.colors || [["#E53333", "#E56600",
                    "#FF9900", "#64451D", "#DFC5A4", "#FFE500"], ["#009900", "#006600", "#99BB00", "#B8D100", "#60D978", "#00D5FF"], ["#337FE5", "#003399", "#4C33E5", "#9933E5", "#CC33E5", "#EE33EE"], ["#FFFFFF", "#CCCCCC", "#999999", "#666666", "#333333", "#000000"]];
        ...
        E(Bb, {
            init: function (a) {
                ...
                b.bind("load", function () {
                    b.unbind();
                    var c = f.iframeDoc(b), e = c.getElementsByTagName("pre")[0], i = "", g,
                        i = e ? e.innerHTML : c.body.innerHTML;
                    try {
                        g = f.json(i)
                    } catch (h) {
        ...
        E(ya, Q, {
            init: function (a) {
                ...
                (e || i || g) && m.append(o);
                l([{btn: e, name: "preview"}, {btn: i, name: "yes"}, {btn: g, name: "no"}], function () {
                    if (this.btn) {
        ...
        Aa.prototype = {
            lang: function (a) {
                ...
                var h = c.toolbar = zb({
                    ...
                    l = t(i) - h.div.height(), n = c.edit = xb({
                ...
                0 ? Qa({
                    moveEl: g, clickEl: m, moveFn: function (a, c, d, e, f, j) {
                        e += j;
                        b(null, e)
                    }
        ...
        Db("core", function (a) {
            ...
            b.clickToolbar("formatblock", function () {
                var a = b.lang("formatblock.formatBlock"), c = {
                        h1: 28,
                        h2: 24, h3: 18, H4: 14, p: 12
                    }, d = b.cmd.val("formatblock"),
                    e = b.createMenu({name: "formatblock", width: b.langType == "en" ? 200 : 150});
                l(a, function (a, f) {
